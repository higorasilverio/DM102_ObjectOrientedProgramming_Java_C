...
public class Banda {
	...
	public void mostraInfosBanda() {
		...
		String setList = "Nenhuma música ainda";
		...
		String agente = "Não contratado ainda";
		if (this.empresario.nome != null)
			agente = this.empresario.nome + " (CNPJ: " + this.empresario.cnpj + ")";
		System.out.println("#---------- INFORMAÇÕES ATUALIZADAS DA BANDA ----------#");
		System.out.println("Banda: " + this.nome + " (" + this.genero + ")");
		System.out.println("Músicos: " + listaDeArtistas);
		System.out.println("Músicas: " + setList);
		System.out.println("Empresário: " + agente);
	}
