...
public class ConcertoDeRock {
	...
	private static void selecionaIntegrante(Banda banda, Musico integrante, String funcao, String nome) {
		...
		System.out.println("Novo integrante: " + integrante.nome + ", para a função de " + integrante.funcao + ".");

	}

	private static void montaRepertorio(Banda banda) {
		System.out.println("#---------- MONTANDO REPERTÓRIO DA BANDA ----------#");
	...
	private static void aprendeMusica(Banda banda, Musica musica, String nome, int tempo) {
		...
		System.out.println("Repertório atualizado: " + musica.nome + ", com " + musica.tempo + " min de duração.");

	}

	private static void contrataEmpresario(Banda banda) {
		System.out.println("#---------- CONTRATANDO EMPRESÁRIO ----------#");
		Empresario empresario = new Empresario();
		empresario.cnpj = 65677404;
		empresario.nome = "Higor Silvério";
		banda.empresario = empresario;
		System.out
				.println("Empresário contratado: " + banda.empresario.nome + ". CNPJ: " + banda.empresario.cnpj + ".");
		System.out.println();
